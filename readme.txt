...
Oceanfinvest WordPress Theme, Copyright 2019-2022 WordPress.org
Oceanfinvest is distributed under the terms of the GNU GPL.
...
Oceanfinvest is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Oceanfinvest bundles the following third-party resources:
...
Bespoke Icons Created For Oceanfinvest
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- oceanfinvest_the_theme_svg()
- oceanfinvest_get_theme_svg()
- oceanfinvest_nav_menu_social_icons()
